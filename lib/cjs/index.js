...
gsapWithCSS.registerPlugin(ScrollTrigger.exports.ScrollTrigger, ScrollToPlugin.exports.ScrollToPlugin);
var goToSection = function (section, anim) {
...
var scrollToY = function (element, autoKill) {
    if (autoKill === void 0) { autoKill = false; }
...
var scrollToX = function (element) {
    return gsapWithCSS.to(window, {
        scrollTo: {
            x: element,
            autoKill: false,
...
var gsapUtil = {
    gsap: gsapWithCSS,
    ScrollTrigger: ScrollTrigger.exports.ScrollTrigger,
    goToSection: goToSection,
    scrollToX: scrollToX,
    scrollToY: scrollToY,
};

var tweenClear = function (anim) {
    if (!anim.isActive) {
        anim.pause(0).kill();
    }
    else {
...
var timelineClear = function (anim) {
    if (!anim.isActive) {
        anim.pause(0).kill();
    }
    else {
...
var useReactGSAP = function (inView, animClassName, fromTween, toTween, isReversed) {
    if (isReversed === void 0) { isReversed = true; }
    react.useEffect(function () {
        if (inView) {
            var anim_1 = gsapUtil.gsap.fromTo('.' + animClassName, fromTween, toTween);
            return function () {
                tweenClear(anim_1);
            };
        }
            ...
            if (isReversed === true) {
                var anim_2 = gsapUtil.gsap.fromTo('.' + animClassName, toTween, fromTween);
                return function () {
                    tweenClear(anim_2);
                };
            }
...
var useReactGsap = useReactGSAP;

exports.gsapUtil = gsapUtil;
exports.timelineClear = timelineClear;
exports.tweenClear = tweenClear;
exports.useReactGsap = useReactGsap;
